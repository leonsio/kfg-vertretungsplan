...
class KfgVertretungsplanCard extends HTMLElement {
  ...
  _render() {
    ...
    </style><ha-card><div class="header"><div class="title">Vertretungsplan</div></div><div class="section">${days.map(day => this._renderDay(day, singleFixedClass)).join('') || '<div class="empty">Keine Vertretungen für die ausgewählten Klassen vorhanden.</div>'}</div></ha-card>`;
  }
